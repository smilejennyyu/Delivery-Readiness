...
model, history, output_val, y_pred_val = train_model(model, train_dataloader, 3000, 1e-6, fig_filename, val_dataloader=val_dataloader)
# %%
confidence = []
for i in output_val:
    if i[0] < 0.5:
...
# # %%
y_pred_test, output_test = evaluate_model(model, X_test_scaled, y_test)
confidence = []
